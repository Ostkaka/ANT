...
namespace ant
{
	...
	public:
		...
		virtual void registerGameLogic(IGameLogic * gameLogic) ANT_OVERRIDE;
		...
		// Physics states
		virtual void                setVelocity(const sf::Vector2f& vel, const ActorId& id) ANT_OVERRIDE;
		virtual const sf::Vector2f& getVelocity(const ActorId& id) ANT_OVERRIDE;
		virtual void                setAngularVelocity(ant::Real rotVel, const ActorId& id) ANT_OVERRIDE;
